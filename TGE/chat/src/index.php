...
<div class="divs col s12 l6" >    
					<div class="fundo col s12">
						...
						<div class="formulariomsg centered" action="index.php" method="POST">
								<textarea onkeydown="autoResize()" name="mensagem" id='msg' class="mensagem" placeholder="Digite sua mensagem aqui. " data-ls-module="charCounter" maxLength="2000" style="resize: none; "></textarea>
