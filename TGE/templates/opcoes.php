...
<ul id="aba_perfil">
    ...
    <li ><a class="perfilLinks" href="http://localhost/TGE/perfil/perfil.php">Perfil</a></li>
    </div>
   ...
   <?php if($_SESSION['sessionType'] == "LoginWithTGE"){
    ...
    <li ><a class="perfilLinks" href="http://localhost/TGE/perfil/seguranca.php">Segurança</a></li>
    </div>';
   }
   ?>
</ul>    
